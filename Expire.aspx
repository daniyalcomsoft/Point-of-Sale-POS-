...
<head runat="server">
    ...
    <%--<link rel="stylesheet" href="App_Script/global/css/skintools.min09a2.css?v2.1.0" />--%>
    <%--<script src="App_Script/assets/js/sections/skintools.min.js"></script>--%>
    <!-- Plugins -->
    ...
    <!--[if lt IE 9]>
    <script src="App_Script/global/vendor/html5shiv/html5shiv.min.js"></script>
    <![endif]-->
    <!--[if lt IE 10]>
    <script src="App_Script/global/vendor/media-match/media.match.min.js"></script>
    <script src="App_Script/global/vendor/respond/respond.min.js"></script>
    <![endif]-->
    <!-- Scripts -->
    ...
    <%----%>
<body class="page-login-v3 layout-full" style="padding-top:30px!important" >
    <form id="form1" runat="server" style="margin:0px!important">
    <!-- Page -->
    <div class="page animsition vertical-align text-center" data-animsition-in="fade-in"
        data-animsition-out="fade-out">
        <div class="page-content vertical-align-middle">
            <img class="brand-img img-responsive"  src="App_Images/CSlogoWhite.png" alt="..." />
       <span style="color:thistle;font-size:25px">Your License has expired! 
<br /> Please Enter a Valid License Key </span>
           <br />
            <div class="row">
                              
                 <asp:TextBox runat="server" TextMode="MultiLine" ID="txtkey"  CssClass="form-control" Width="100%" placeholder="License key" />
                <asp:RequiredFieldValidator  runat="server" ControlToValidate="txtkey"
                                             ErrorMessage="Please Enter License Key!" Display ="Dynamic" ForeColor="white"  ValidationGroup="Validate" ></asp:RequiredFieldValidator>
                 <span runat="server" id="lbmsg" style="color:white;font-size:15px"></span>   
                <br /> 
                  <asp:Button runat="server" ID="btnValidate" OnClick="btnValidate_Click" ValidationGroup="Validate"  CssClass="btn1 btn-default waves-effect waves-light"  Text="Validate" />
                           
                 </div>
           <br />
          <span style="color:thistle;font-size:25px">  or Contact the Support Team.<br />+92 321 3853153 <br /> +92 302 2433400<br /><a style="color:thistle;font-size:25px" target="_blank" href="http://computesale.com/">www.computesale.com</a></span>
