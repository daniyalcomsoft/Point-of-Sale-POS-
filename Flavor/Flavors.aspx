<%@ Page Language="C#" AutoEventWireup="true"   MasterPageFile="~/MasterPage.master" CodeFile="Flavors.aspx.cs" Inherits="Flavor_Flavors" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script>
        $(document).ready(function () {
            $('#btnAddFlavor').click(function () {
        ...
        <script type="text/javascript">
          ...
          <div class="panel panel-bordered panel-primary">
                <div class="panel-heading form-group">
                    <h3 class="panel-title">Flavor Info</h3>
                </div>
                <div class="panel-body">
                     <div class="row">
                        ...
                        <div class="col-sm-4 form-group">
                          <button type="button"  data-toggle="modal" data-target="#ModalTable" class="btn btn-primary pull-right" id="btnAddFlavor">Add Flavor</button>
                        </div>
                    </div>
                      <div class="GridWrapper table-responsive">
                                     <asp:GridView runat="server" EmptyDataRowStyle-HorizontalAlign="Center" ShowHeaderWhenEmpty="true" AutoGenerateColumns="False" ID="grdItems" OnPageIndexChanging="grdItems_PageIndexChanging" AllowPaging="true" PageSize="10" DataKeyNames="FlavorID" CssClass="table table-striped table-bordered dataTable table-responsive table-hover" >
                                        <EmptyDataTemplate>
                                            <h4>No record found</h4>
                                        </EmptyDataTemplate>
                                          <Columns>

                                              <asp:TemplateField SortExpression="FlavorName">
                                    <HeaderTemplate>
                                        <bold>Flavor</bold>
                                        <asp:TextBox runat="server" onkeypress="return runScript(event);" CssClass="form-control" ID="txtFlavorName" placeholder="Flavor"></asp:TextBox>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <%# Eval("FlavorName") %>
                                    </ItemTemplate>
                                             ...
                                             <asp:CheckBoxField ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" DataField="Active" HeaderText="Active" SortExpression="Active" />   
                                              <asp:TemplateField ItemStyle-Width="20%" HeaderText="Action"  >
                                                 <ItemTemplate>
                                                     <asp:LinkButton runat="server" ToolTip="View" OnCommand="btnView_Command" CommandArgument='<%# Eval("FlavorID") %>'   ID="btnView" >
                                                         <i class="icon fa-eye icon_custom" aria-hidden="true"></i>
                                                     </asp:LinkButton>
                                                       <asp:LinkButton runat="server" ToolTip="Edit" OnCommand="btnEdit_Command" CommandArgument='<%# Eval("FlavorID") %>'  ID="btnEdit" >
                                                         <i class="icon fa-edit icon_custom" aria-hidden="true"></i>
                                                     </asp:LinkButton>
                                                         <asp:LinkButton runat="server" ToolTip="Delete" OnCommand="btnDelete_Command" CommandArgument='<%# Eval("FlavorID") %>'  ID="btnDelete" >
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Flavor Info</h4>
                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-horizontal" id="ModalForm">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" >Flavor :</label>
                                    <div class="col-sm-7">
                                          <asp:HiddenField runat="server" ID="hdID" />
                                        <asp:HiddenField runat="server" ID="hdName" />
                                        <asp:TextBox runat="server" ID="txtFlavor" CssClass="form-control" Width="100%" placeholder="Flavor Name" />
                                    <asp:RequiredFieldValidator  runat="server" ControlToValidate="txtFlavor"
