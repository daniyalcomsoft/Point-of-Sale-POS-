<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Waiters.aspx.cs" Inherits="Waiters_Waiters" %>
        ...
        <script type="text/javascript">
          ...
          <div class="panel panel-bordered panel-primary">
                <div class="panel-heading form-group">
                    <h3 class="panel-title">Waiter List</h3>
                </div>
                <div class="panel-body">
                     <div class="row">
                        ...
                        <div class="col-sm-4 form-group">
                          <button type="button"  data-toggle="modal" data-target="#ModalVendor" class="btn btn-primary pull-right" id="btnAddVendor">Add Waiter</button>
                        </div>
                    </div>
                      <div class="GridWrapper table-responsive">
                                     <asp:GridView runat="server" EmptyDataRowStyle-HorizontalAlign="Center" ShowHeaderWhenEmpty="true" AutoGenerateColumns="False" ID="grd" OnPageIndexChanging="grd_PageIndexChanging" AllowPaging="true" PageSize="10" DataKeyNames="WaiterID" CssClass="table table-striped table-bordered dataTable table-responsive table-hover" >
                                        <EmptyDataTemplate>
                                    ...
                                    <HeaderTemplate>
                                        <bold>Cell #</bold>
                                        <asp:TextBox runat="server" onkeypress="return runScript(event);" CssClass="form-control" ID="txtPhone" placeholder="Cell #"></asp:TextBox>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <%# Eval("PhoneNo") %>
                                    </ItemTemplate>
                                        ...
                                        <%# Eval("Address") %>
                                              ...
                                              <asp:CheckBoxField ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" DataField="Active" HeaderText="Active" SortExpression="Active" />                                 
                                               <asp:TemplateField ItemStyle-Width="15%"  HeaderText="Action" >
                                                 <ItemTemplate>
                                                      <asp:LinkButton runat="server" ToolTip="View"  OnCommand="btnView_Command" CommandArgument='<%# Eval("WaiterID") %>' ID="btnView" >
                                                         <i class="icon fa-eye icon_custom" aria-hidden="true"></i>
                                                     </asp:LinkButton>
                                                     <asp:LinkButton runat="server" ToolTip="Edit" OnCommand="btnEdit_Command"  CommandArgument='<%# Eval("WaiterID") %>'  ID="btnEdit" >
                                                         <i class="icon fa-edit icon_custom"  aria-hidden="true"></i>
                                                     </asp:LinkButton>
                                                      <asp:LinkButton runat="server" ToolTip="Delete" OnCommand="btnDelete_Command" CommandArgument='<%# Eval("WaiterID") %>'  ID="btnDelete" >
                        ...
                        <div class="col-sm-12">
                            <div class="form-horizontal" id="ModalForm">                               
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <asp:TextBox runat="server" ID="txtCell" CssClass="form-control" onkeypress="return isFloatNumber(this,event);" MaxLength="11" Width="100%" placeholder="Cell #" />
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <asp:TextBox runat="server" ID="txtCNIC" CssClass="form-control" onkeypress="return isFloatNumber(this,event);" MaxLength="13" Width="100%"  placeholder="CNIC #" />                                        
                                    </div>
                                </div>
                                 <div class="form-group">
