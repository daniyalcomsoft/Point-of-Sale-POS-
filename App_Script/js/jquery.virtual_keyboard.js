...
(function($){
    ...
    var Keyboard = function(elemento, opciones){
        ...
        var language = [];
        var $layout = $("<div id='keyboard' class='row VKey'/>");
        ...
        var optionsKeyboard = $.extend({    // Opciones del teclado y sus valores x defecto
            ...
            hide_on_focus_out: false,    // Esconder el teclado cuando pierda el focus el input. Solo si is_hidden: true
        ...
        setupKeys = function(){
            ...
            $('<div/>', {
                'id': 'keypad',
                'class': 'col-md-12 '+optionsKeyboard.theme,
                html: keys.join('')
        ...
        _this.SubmitKey = function () { $("[Id$=txtSearch]").change();  };
