...
//        },
//        bind: function () {
//            var self = this;//mouseenter.site.menu,
...
//                var $item = $(this);
//                $item.is(".has-sub") && $item.parent(".site-menu").length > 0 && $item.children(".site-menu-sub").css("max-height", ""), $item.removeClass("hover")
...
//                    $item.addClass("open")
//                }), $item.siblings(".open").trigger("close.site.menu"), e.stopPropagation()
...
//                var $item = $(this);
//                0 == $item.parent(".site-menu").length && $item.is(".has-sub") && $(e.target).closest(".site-menu-item").is(this) ? $item.is(".open") ? $item.trigger("close.site.menu") : $item.trigger("open.site.menu") : $item.is(".active") || ($item.siblings(".active").trigger("deactive.site.menu"), $item.trigger("active.site.menu")), e.stopPropagation()
//            }).on("tap.site.menu", "> .site-menu-item", function () {
//                var $item = $(this);
//                if ($item.is(".has-sub") && $item.parent(".site-menu").length > 0)
//                    if ($item.siblings(".hover").each(function () {
//                            var $item = $(this);
//                            $item.is(".has-sub") && $item.parent(".site-menu").length > 0 && $item.children(".site-menu-sub").css("max-height", ""), $item.removeClass("hover")
//                    }), $item.is(".hover")) $item.is(".has-sub") && $item.parent(".site-menu").length > 0 && $item.children(".site-menu-sub").css("max-height", ""), $item.removeClass("hover");
//                    else {
//                        if ($item.is(".has-sub") && $item.parent(".site-menu").length > 0) {
//                            var $sub = $item.children(".site-menu-sub");
//                            self.position($item, $sub)
        ...
        bind: function () {
            ...
            this.$instance.on("mouseenter.site.menu", ".site-menu-item", function (e) {
                ...
                $(this).one("touchend.site.menu", function () {
                   // debugger
                    var $item = $(this);
                    if ($item.off("touchmove.site.menu"), $item.is(".has-sub") && $item.parent(".site-menu").length > 0)
                        {
                        if ($item.siblings(".hover").each(function () {
                                var $item = $(this);
                                $item.is(".has-sub") && $item.parent(".site-menu").length > 0 && $item.children(".site-menu-sub").css("max-height", ""), $item.removeClass("hover")
                    ...
                    else if ($item.off("touchmove.site.menu"),  $item.parent(".site-menu").length > 0)
                    {
                        window.location.href = $(this).find("a").attr("href");
                    }
                }).one("touchmove.site.menu", function (e) {
                    // debugger
                  //  e.preventDefault()
...
//    }).on("click.site.menu ", ".site-menu-item", function (e) {
//        var $item = $(this);
//        0 === $item.parent(".site-menu").length && $item.is(".has-sub") && $(e.target).closest(".site-menu-item").is(this) && ($item.is(".open") ? $item.trigger("close.site.menu") : $item.trigger("open.site.menu")), e.stopPropagation()
//    }).on("touchstart.site.menu", ".site-menu-item", function () {
//        $(this).one("touchend.site.menu", function () {
//            var $item = $(this);
//            if ($item.off("touchmove.site.menu"), $item.is(".has-sub") && $item.parent(".site-menu").length > 0)
