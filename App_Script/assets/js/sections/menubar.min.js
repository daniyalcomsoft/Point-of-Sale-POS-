! function (window, document, $) {
    ...
    $.site.menubar = {
        ...
        init: function () {
            if ($html.removeClass("css-menubar").addClass("js-menubar"), this.$instance = $(".site-menubar"), 0 !== this.$instance.length) {
                ...
                this.$instance.on("changed.site.menubar", function () {
                    self.update()
                }), this.hoverscroll.enable(), this.change()
            }
        },
        change: function () {
            var breakpoint = Breakpoints.current();
            $body.hasClass("site-menubar-keep") && $body.hasClass("site-menubar-hide") ? (this.hide(), breakpoint && $body.hasClass("site-menubar-unfold") && "xs" === breakpoint.name && this.hide()) : (this.reset(), breakpoint && ("xs" === breakpoint.name ? this.hide() : this.unfold()))
        },
        ...
        reset: function () {
            this.opened = null, $body.removeClass("site-menubar-hide site-menubar-unfold")
        },
        hide: function () {
            this.opened !== !1 && this.animate(function () {
                $body.removeClass("site-menubar-unfold").addClass("site-menubar-hide"), this.opened = !1
            }, function () { })
        },
        unfold: function () {
            this.opened !== !0 && this.animate(function () {
                $body.removeClass("site-menubar-hide").addClass("site-menubar-unfold"), this.opened = !0
            }, function () {
                $.site.resize()
            })
        },
