<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SaleRegisterReport.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="Rpts_SaleRegisterReport" %>
                        ...
                        <label class="control-label">Items :</label>
                            ...
                            <asp:TextBox runat="server" ID="txtItem" TabIndex="0" CssClass="form-control mgtop4 selectpicker ui-autocomplete-input" placeholder="All Items" />
                              <asp:AutoCompleteExtender ServiceMethod="SearchItem" MinimumPrefixLength="1" UseContextKey="true"
                                    ...
                                    TargetControlID="txtItem" ID="AutoCompleteExtender2" runat="server" FirstRowSelected="true" OnClientItemSelected="ClientItemSelected">
                                </asp:AutoCompleteExtender> 
