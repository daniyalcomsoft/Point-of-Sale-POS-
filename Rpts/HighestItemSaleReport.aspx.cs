...
public partial class Rpts_HighestItemSaleReport : System.Web.UI.Page
{
    ...
    { 
        ...
        if (!IsPostBack)
        {
            ...
            foreach (DataRow dr in dtRole.Rows)
            {
                ...
                if (dtRole.Rows[row]["PageUrl"].ToString() == "Rpts/HighestItemSaleReport.aspx")
                {
            ...
            {
                if (pageName == "Rpts/HighestItemSaleReport.aspx" && view == true)
                {
    ...
    private void ConfigureReports()
    {
        try
        {
            ...
            dt = BL.HighestItemSaleReport(FromDate.Text, ToDate.Text, hdCategoryID.Value == "" ? null : hdCategoryID.Value, hdItemID.Value == "" ? null : hdItemID.Value, Convert.ToInt16(rdQty.Checked));
            ...
            param[4] = new ReportParameter("Sale", rdSale.Checked ? "Highest Sale Wise" : "Highest Qty Wise");
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~//Rpts//rdlcReports//ItemWiseSaleReport.rdlc");
