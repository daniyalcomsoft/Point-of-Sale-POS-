...
public partial class Reports_ProductDetailReport : System.Web.UI.Page
{
         ...
         if (Session["PSMSSession"] == null)
        {
         ...
         if (!IsPostBack)
         {
            ...
            foreach (DataRow dr in dtRole.Rows)
            {
                ...
                if (dtRole.Rows[row]["PageUrl"].ToString() == "Rpts/ItemDetailReport.aspx")
                {
            ...
            {
                if (pageName == "Rpts/ItemDetailReport.aspx" && view == true)
                {
     ...
     private void ConfigureReports()
    {
        try
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~//Rpts//rdlcReports//ItemDetailReport.rdlc");
