<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HighestItemProfitReport.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="Rpts_HighestItemProfitReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="col-sm-12">
          ...
          <div class="col-md-3">
                ...
                <asp:RadioButton runat="server" CssClass="radio-custom" GroupName="AB" ID="rdQuantity" Checked="true"  Text="Sale"/>
                <asp:RadioButton runat="server" CssClass="radio-custom" GroupName="AB" ID="rdProfit"  Text="Profit" />
          </div>        
           <div class="col-md-1"> 
               <br />
