<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ItemListReport.aspx.cs"  MasterPageFile="~/MasterPage.master"Inherits="Rpts_ItemListReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
     <script>
         ...
         function selectpic() {
          ...
          function ClientCategorySelected(sender, e) {
                        ...
                        <label class="col-sm-1 control-label" style="margin-top:9px; margin-left:-15px;">Category:</label>
                            <asp:TextBox runat="server" ID="cmbCategory" TabIndex="0" CssClass="form-control mgtop4 selectpicker ui-autocomplete-input" placeholder="All Categories" />
                              ...
                              <asp:AutoCompleteExtender ServiceMethod="SearchCategory" MinimumPrefixLength="1"
                                    ...
                                    TargetControlID="cmbCategory" ID="AutoCompleteExtender1" runat="server" FirstRowSelected="true" OnClientItemSelected="ClientCategorySelected">
