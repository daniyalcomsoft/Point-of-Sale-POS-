...
public partial class Rpts_ProfitBillWiseReport : System.Web.UI.Page
{
    ...
    { 
        ...
        if (!IsPostBack)
        {
            ...
            foreach (DataRow dr in dtRole.Rows)
            {
                ...
                if (dtRole.Rows[row]["PageUrl"].ToString() == "Rpts/ProfitBillWiseReport.aspx")
                {
            ...
            {
                if (pageName == "Rpts/ProfitBillWiseReport.aspx" && view == true)
                {
    ...
    private void ConfigureReports()
    {
        try
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~//Rpts//rdlcReports//ProfitBillWiseReport.rdlc");
