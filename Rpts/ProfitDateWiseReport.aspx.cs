...
public partial class Rpts_ProfitDateWiseReport : System.Web.UI.Page
{
    ...
    { 
        ...
        if (!IsPostBack)
        {
            ...
            foreach (DataRow dr in dtRole.Rows)
            {
                ...
                if (dtRole.Rows[row]["PageUrl"].ToString() == "Rpts/ProfitDateWiseReport.aspx")
                {
            ...
            {
                if (pageName == "Rpts/ProfitDateWiseReport.aspx" && view == true)
                {
    ...
    private void ConfigureReports()
    {
        try
        {
            ...
            dt = BL.ProfitDateWiseReport(FromDate.Text, ToDate.Text, hdCategoryID.Value == "" ? null : hdCategoryID.Value, hdItemID.Value == "" ? null : hdItemID.Value);
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~//Rpts//rdlcReports//DateWiseProfitReport.rdlc");
